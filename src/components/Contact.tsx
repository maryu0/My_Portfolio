            ...
            <div className="container mx-auto max-w-6xl">
                ...
                >
                    ...
                    <p className="text-album-beige/70 font-mono mt-4 max-w-2xl">
                        Let's collaborate on your next project. Drop me a message and I'll get back to you.
                    </p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    >
                        {/* Info Cards */}
                        {[
                            { icon: Mail, label: 'Email', value: 'maryu.3738@gmail.com', color: 'neon-cyan', href: 'mailto:maryu.3738@gmail.com' },
                            { icon: Linkedin, label: 'LinkedIn', value: 'ayush-kumar-ab8a3a2ab', color: 'neon-pink', href: 'https://linkedin.com/in/ayush-kumar-ab8a3a2ab' },
                            { icon: MapPin, label: 'Location', value: 'Bhubaneswar, Odisha, India', color: 'neon-yellow', href: '#' },
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className={`w-12 h-12 rounded-full bg-${color}/20 border-2 border-${color} flex items-center justify-center group-hover:scale-110 transition-transform`}>
                                    ...
                                    <div>
                                        ...
                                        <div className="text-album-paper font-mono">
                                            {value}
                                        </div>
                                    </div>
                                </div>
