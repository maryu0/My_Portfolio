            ...
            <div className="container mx-auto max-w-5xl">
                ...
                >
                    ...
                    <p className="text-album-beige/70 font-mono mt-4 max-w-2xl">
                        My journey through the tech world. Each stop has shaped who I am today.
                    </p>
                </motion.div>
                ...
                >
                    <motion.button
                        className="px-8 py-4 bg-neon-orange text-vinyl-dark hover:bg-neon-pink transition-colors font-mono tracking-wider rounded-lg flex items-center gap-3"
